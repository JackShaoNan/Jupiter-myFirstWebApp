...
public class TicketMasterAPI {
	...
	private static final String DEFAULT_KEYWORD = "sports";
	private static final String API_KEY = "roSeeNxGU37mUowtGoziuMgNn57peBWc";
	
	//three params : latitude, longtitude, keyword
	...
	/**
	 * Helper methods for using Item class
	 */
	//data format
	//  {
	//        "_embedded": {
	...
	//helper function: print JSON array returned from TicketMaster for debugging
